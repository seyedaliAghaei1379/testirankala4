 ...
 */
 ...
 $Cnfg = $ths->getSetting();
    ...
    if(!$MyList){
        ...
        $MyList = $ProductClass->get_all($Cond2, ['code', 'title', 'model', 'score', 'score_person', 'img_id', 'seo', 'confirm_count', 'confirm_price', 'product_id', 'rel_id'], ['`product`.`ordr`', 'desc'], [0, 4]);
        ...
        <div class="block block-products-carousel" data-layout="grid-6">
            <div class="container">
                <div class="section-header">
                    <div class="section-header__body"><h2 class="section-header__title">محصولات مرتبط</h2>
